...
ROOMS = {
 ...
 По центру стоит пьедестал с запечатанным сундуком.',
        'exits': {'south': 'entrance', 'west': 'library', 'east':'coffee_room',\
                   'north': 'treasure_room'},
        'items': [],
 ...
 может быть ключ от сокровищницы.',
          ...
          'items': ['ancient_book'],
          'puzzle': ('В одном свитке вопрос: "Назовите год основания Руси?"\
 (ответ одна цифра).','862'),
          'reward': 'souvenir_key'
    },
        'armory': {
 ...
 (подсказка: это число пятикратного шага, 2*5= ? )',\
    ...
    'coffee_room': {
          'description': 'Кофейная комната. В середине комнаты стоит диван\
 с кофейным столиком. На столе свежая чашка кофе для восстановления сил.',
          'exits': {'west': 'hall', 'south': 'cabinet_room'},
          'items': ['coffee_cup'],
          'puzzle': ('Загадка: Солнце с брызгами играет, Семь цветных полос включает.',\
                     'радуга'),
          'reward': None
    }, 
    'cabinet_room': {
          'description':'Комната, у стены стоит стол, на столе лист бумаги.\
 На нем написан код для открытия сундука с сокровищами. Код: 10.',    
          'exits': {'north': 'coffee_room', 'west':'treasure_room'},
          'items': ['paper_page'],
          'puzzle': None,
          'reward': None
    }
